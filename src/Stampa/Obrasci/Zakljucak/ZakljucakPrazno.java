 ...
 * @author Nebojsa
 */
public class ZakljucakPrazno extends NijeTabela{
    ...
    public ZakljucakPrazno(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
