 ...
 * @author Nebojsa
 */
public class ZakljucakClassic extends NijeTabela{
    ...
    public ZakljucakClassic(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
