 ...
 * @author Nebojsa
 */
public class FooterClassic extends NijeTabela{
    ...
    public FooterClassic(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
    ...
    public void FormirajPolja(){
        ...
        maxVisina = 0;
            lineVector.addElement(definisiPolje.DefPoljeLineNo(fontName, fontSize-2, "", alignment[0], maxVisina, sirine[0], "", "Footer"));                    //Polje 1 
        ...
        maxVisina = 0;  
            lineVector.addElement(definisiPolje.DefPoljeLineNo(fontName, fontSize-2, "Datum Stampe: &&%%DateTime&&%%", alignment[0], maxVisina, sirine[0], "i", "Footer"));  //Polje 1       
        lineVectorAll.addElement(lineVector);         
    }
