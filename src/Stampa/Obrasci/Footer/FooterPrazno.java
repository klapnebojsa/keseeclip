 ...
 * @author Nebojsa
 */
public class FooterPrazno extends NijeTabela{
    ...
    public FooterPrazno(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
