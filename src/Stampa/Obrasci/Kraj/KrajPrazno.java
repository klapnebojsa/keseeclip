 ...
 * @author Nebojsa
 */
public class KrajPrazno extends NijeTabela{
    ...
    public KrajPrazno(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
