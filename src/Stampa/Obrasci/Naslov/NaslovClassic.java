 ...
 * @author Nebojsa
 */
public class NaslovClassic extends NijeTabela{
    ...
    public NaslovClassic(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
    ...
    public void FormirajPolja(){
        ...
        maxVisina = 0;  
            lineVector.addElement(definisiPolje.DefPoljeLineNo(fontName, fontSize+2, "Štampa: &&%%FormName&&%%", alignment[0], maxVisina, sirine[0], "B", "Naslov"));  //Polje 1       
        ...
        maxVisina = 0;
            lineVector.addElement(definisiPolje.DefPoljeLineNo(fontName, fontSize-2, "", alignment[0], maxVisina, sirine[0], ""));                    //Polje 1 
        lineVectorAll.addElement(lineVector);*/         
    }
