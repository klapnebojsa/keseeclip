 ...
 * @author Nebojsa
 */
public class HeaderPrazno extends NijeTabela{
    ...
    public HeaderPrazno(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
