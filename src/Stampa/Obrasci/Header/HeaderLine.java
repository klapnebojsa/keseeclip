 ...
 * @author Nebojsa
 */
public class HeaderLine  extends NijeTabela{
    ...
    public HeaderLine(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
    ...
    public void FormirajPolja(){
        ...
        maxVisina = 0; 
            ...
            lineVector.addElement(definisiPolje.DefPoljeLineAll(fontName, fontSize, "&&%%FirNaz&&%% - &&%%FirMes&&%%"  , alignment[0], maxVisina, sirine[0], "", "Header"));             
            lineVector.addElement(definisiPolje.DefPoljeLineAll(fontName, fontSize-2, "Strana: &&%%PageOf&&%% od &&%%OfPages&&%%", alignment[1], maxVisina, sirine[1], "I", "Header"));  //Polje 2       
