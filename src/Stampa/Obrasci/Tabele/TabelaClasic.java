...
public class TabelaClasic extends OblikStampe{
    int red;
    int col;
    int maxCol;
    String cijeJe;
        
    public TabelaClasic(String fontName, int fontSize, int red, int col, int maxCol, String vrednost, String alignment, String boldItalic){
