 ...
 * @author Nebojsa
 */
public class UvodClassic extends NijeTabela{
    ...
    public UvodClassic(FormPrintPreview formPrintPreview, String imeKlase, String fontName, int fontSize, PageFormat pageFormat){
